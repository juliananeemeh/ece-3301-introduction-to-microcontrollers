...
void update_LCD_color(char direction, char color)
{
    ...
    else if (color == Color_Red)     //if Color off make all circles black but leave outline
    {
    ...
    else if (color == Color_Yellow)     //if Color off make all circles black but leave outline
    {
        fillCircle(XRED, Circle_Y, Circle_Size, ST7735_BLACK);
