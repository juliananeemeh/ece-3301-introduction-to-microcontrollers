...
void Do_Setup_Time(void)
{
    ...
    setup_minute = bcd_2_dec(minute);                                           // repeat for minute, hour, day, month, year                                       
...
void Increase_Time()
{
            ...
            {
                case 0:
                    setup_hour++;                                               // increment hour
                    if (setup_hour == 24) setup_hour = 0;                       // if hour = 24, hour = 0
                    break;

                case 1:
                    // add code here to handle minute increment - also check if new minute is 60. If so, make it 0
                    setup_minute++;                                             // increment minute
                    if(setup_minute == 60) setup_minute = 0;                    // if minute = 60, minute = 0
                    break;

                case 2:
                    // add code here to handle second increment - also check if new second is 60. If so, make it 0
                    setup_second++;                                             // increment second
                    if(setup_second == 60) setup_second = 0;                    // if second = 60, second = 0
                    break;

                case 3:
                    // add code here to handle month increment - also check if new month is 13. If so, make it 1
                    setup_month++;                                              // increment month
                    if(setup_month == 13) setup_month = 1;                      // if month = 13, month = 1
                    break;

                case 4:
                    // add code here to handle day increment - also check if new day is 32. If so, make it 1  
                    setup_day++;                                                // increment day
                    if(setup_day == 32) setup_day = 1;                          // if day = 32, day = 1
                    break;

                case 5:
                    // add code here to handle year increment - also check if new year is 100. If so, make it 0
                    setup_year++;                                               // increment year
                    if(setup_year == 100) setup_year = 0;                       // if year = 100, year = 0
                    break;
...
void Decrease_Time()
{
            ...
            {
                case 0:
                    if (setup_hour == 0) setup_hour = 23;                       // if hour = 0, hour = 23
                    else --setup_hour;                                          // decrement hour
                    break;
                case 1:
					// add code here to check is minute is at 0. If not, decrement. If yes, if so, make it 59
                    if(setup_minute == 0) setup_minute = 59;                    // if minute = 0, minute = 59
                    else setup_minute--;                                        // decrement minute
                    break;

                case 2:
                    // add code here to check is second is at 0. If not, decrement. If yes, if so, make it 59
                    if(setup_second == 0) setup_second = 59;                    // if second = 0, second = 59
                    else setup_second--;                                        // decrement second
                    break;

                case 3:
                    // add code here to check is month is at 1. If not, decrement. If yes, if so, make it 12
                    if(setup_month == 1) setup_month = 12;                      // if month = 1, month = 12
                    else setup_month--;                                         // decrement month
                    break;

                case 4:
                    // add code here to check is day is at 1. If not, decrement. If yes, if so, make it 31
                    if(setup_day == 1) setup_day = 31;                          // if day = 1, day = 31
                    else setup_day--;                                           // decrement day
                    break;

                case 5:
                    // add code here to check is year is at 00. If not, decrement. If yes, if so, make it 99
                    if(setup_year == 00) setup_year = 99;                       // if year = 00, year = 99
                    else setup_year--;                                          // decrement year
                    break;
